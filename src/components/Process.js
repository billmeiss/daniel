          ...
          <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
              ...
              <div className="mt-6 text-gray-500 space-y-6">
                <p className="text-lg">
                  Remote learning is not working well in schools, kids are disengaged, learning less and socialising less -> sadness and frustration
                </p>
                <p className="text-base leading-7">
                  With us: 1 Creative space and 1 STEM lesson per week, advance in school content, socialise and keep their neural networks open -> happy + confident
                </p>
                <p className="text-base leading-7">
                  Kids return to school classes happier -> take burden of parents -> turn kids to little einsteins
                </p>
              </div>
            </div>
